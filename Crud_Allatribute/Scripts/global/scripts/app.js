var App = function () {
        ...
        f = function () {
            $("body").on("click", ".portlet > .portlet-title > .tools > a.remove", function (t) {
                ...
                o ? (App.blockUI({
                    ...
                    error: function () {
                        App.unblockUI(e);
                        var t = "Error on reloading the content. Please check your connection and try again.";
                        "toastr" == a && toastr ? toastr.error(t) : "notific8" == a && $.notific8 ? ($.notific8("zindex", 11500), $.notific8(t, {
                            theme: "ruby",
                            life: 3e3
                        })) : alert(t)
                    }
                ...
                t.preventDefault();
                $(this).closest(".portlet").children(".portlet-body");
                $(this).hasClass("collapse") ? ($(".jstree").jstree("close_all"), $(this).children().removeClass(), $(this).children().addClass("fa fa-expand"), $(this).removeClass("collapse").addClass("expand")) : ($(".jstree").jstree("open_all"), $(this).children().removeClass(), $(this).children().addClass("fa fa-compress"), $(this).removeClass("expand").addClass("collapse"))
            })
        },
        b = function () {
            if ($().uniform) {
    ...
    return {
        init: function () {
            h(), u(), g(), b(), m(), v(), T(), U(), G(), f(), A(), I(), k(), w(), P(), C(), x(), y(), S(), D(), this.addResizeHandler(H), E()
        },
        initAjax: function () {
            b(), m(), v(), z(), T(), G(), U(), I(), w(), P(), C(), y()
        },
        ...
        blockUI: function (t) {
            ...
            if (e = t.animate ? '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><div class="block-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>' : t.iconOnly ? '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><img src="' + this.getGlobalImgPath() + 'loading-spinner-grey.gif" align=""></div>' : t.textOnly ? '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><span>&nbsp;&nbsp;' + (t.message ? t.message : "LOADING...") + "</span></div>" : '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><img src="' + this.getGlobalImgPath() + 'loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (t.message ? t.message : "LOADING...") + "</span></div>", t.target) {
                ...
                o.height() <= $(window).height() && (t.cenrerY = !0), o.block({
                    message: e,
                    baseZ: t.zIndex ? t.zIndex : 9999999,
